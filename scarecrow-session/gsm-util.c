 ...
 * default Scarecrow $GNOME_SHELL_SESSION_MODE will become unset).
 */
                                         ...
                                         gboolean    autostart_first)
{
        ...
        /* look for scarecrow vendor prefix */
        if (app_path == NULL) {
                g_free (desktop_file);
...
gsm_util_generate_startup_id (void)
{
         ...
         * Scarecrow and KDE have traditionally used a fourth address
         * format in this case:
